              ...
              <div className="mf-contact-block">
                ...
                <div className="mf-map-wrap">
                  <iframe
                    ...
                    width="100%" height="160" style={{ border: 0, borderRadius: '10px', display: 'block' }}
                    allowFullScreen={true} loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade"
                    title="Medical365 Office Location — Bhamashah Techno Hub, Jaipur"
                    aria-label="Google Maps showing Medical365 office in Malviya Nagar, Jaipur">
                  </iframe>
                </div>
              </div>
            </div>
